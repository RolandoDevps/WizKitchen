<?php 
$title_header = "LE POTAGER D’ANNIE";
  ...
  <div class="container">
    <div class="content_item no_padding">
      ...
      <div class="custo-card">
        <div class="card_img">
          <img src="assets/images/items/10.png" alt="">
        </div>
        <div class="card_description">
          <h2>À la découverte d’Annie</h2>
      ...
      <div class="content_card_item">
        <div class="card_item">
            <div class="card_image">
                <img src="assets/images/items/24.png" alt="">
            </div>
        ...
        <div class="card_item">
            <div class="card_image">
                <img src="assets/images/items/25.png" alt="">
            </div>
            <div class="card_title_item">
                <h3>POIREAUX</h3>
            </div>
        ...
        <div class="card_item">
            <div class="card_image">
                <img src="assets/images/items/26.png" alt="">
            </div>
            <div class="card_title_item">
                <h3>RADIS</h3>
            </div>
        ...
        <span class="content_span">
            <span class="span0-Yx7w3G">Quand trouver ses produits ? <br></span>
...
<section class="section_item mb-9">
  <div class="container">
    <div class="content_item no_padding">

      <div class="custo-card">
        <div class="card_img">
          <img src="assets/images/items/27.png" alt="">
        </div>
        <div class="card_description">
          <h2>Où trouver ses produits ?</h2>
          <p>dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap</p>
          <div class="container_btn_link">
            <a href="#" class="btn_link color_marron">Découvrir</a>
          </div>
