      ...
      <div class="content_card_item">
        <div class="card_item">
            <div class="card_image">
                <img src="assets/images/items/9.png" alt="">
            </div>
        ...
        <div class="card_item">
            <div class="card_image">
                <img src="assets/images/items/11.png" alt="">
            </div>
            <div class="card_title_item">
    ...
    <div class="content_item no_padding">
      ...
      <div class="content_card_item">
        <div class="card_item">
            ...
            <div class="card_title_item">
                <h3>ÉCOLE - RESTAURANT <br> DES TULIPES</h3>
            </div>
        </div>
        <div class="card_item">
            <div class="card_image">
                <img src="assets/images/items/12.png" alt="">
            </div>
            <div class="card_title_item">
                <h3>LA CANTINE DU 11</h3>
            </div>
        </div>
        <div class="card_item">
            <div class="card_image">
                <img src="assets/images/items/13.png" alt="">
            </div>
            <div class="card_title_item">
