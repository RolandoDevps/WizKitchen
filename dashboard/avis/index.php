...
<div id="page-content-wrapper">
    ...
    <div class="container-fluid px-4">
        ...
        <div class="wrap_form_avis">
            <form class="form-add-avis" autocomplete="off" action="" method="post">
                <div class="content_avis row">
                    ...
                    <div class="input_main col-sm-1" style="min-width: 115px">
        ...
        <div class="my-5">
            <h3 class="fs-4 mb-3">Liste des avis</h3>
                    ...
                    while ($avis = $response->fetch()) {
                        ...
                        <tr>
                            ...
                            <td align="right">
                                ...
                                <i id="<?php echo $avis['id']; ?>"
                                   class="fas fa-trash text-danger table-action-item delete-avis"></i>
                            </td>
                        </tr>
                        <?php
