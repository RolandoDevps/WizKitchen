...
<!-- /#sidebar-wrapper -->
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid px-4">
            ...
            <div class="my-5">
                <h3 class="fs-4 mb-3">Liste des producteurs</h3>
                    ...
                    <table class="table bg-white rounded shadow-sm  table-hover">
                        ...
                        while ($producteur = $response->fetch()) {
                            ...
                            <tr>
                                ...
                                <td><img src="../../uploads/<?php echo $producteur['image_url']; ?>" height="100" width="100"  alt="img"/></td>
        ...
        function add_producteur() {
            $('.form-add-producteur').submit(function (e) {
                ...
                if (label !== ''&& description !== '' && image_name !== '') {
                    $.ajax({
                        url:'traitements/add-producteur.php',
                        method:'POST',
                        data:form_data,
                        contentType:false,
                        cache:false,
