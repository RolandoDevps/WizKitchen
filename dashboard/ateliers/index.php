    ...
    <div id="page-content-wrapper">
        <nav class="navbar navbar-expand-lg navbar-light py-4 px-4 d-flex justify-content-between">
            <div class="d-flex align-items-center">
                ...
                <h2 class="fs-2 m-0">Dashboard / Ateliers</h2>
            </div>
...
<!--                            Drag and drop or Select image to upload:-->
            ...
            <div class="my-5">
                <h3 class="fs-4 mb-3">Liste des ateliers</h3>
                        ...
                        while ($atelier = $response->fetch()) {
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    <i id="<?php echo $atelier['id']; ?>" class="fas fa-edit mx-4 primary-text table-action-item"></i>
                                    <i id="<?php echo $atelier['id']; ?>" class="fas fa-trash text-danger table-action-item delete-atelier"></i>
                                </td>
                            </tr>
                            <?php
